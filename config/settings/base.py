...
APPS_DIR = BASE_DIR / "apeiro_agency"
...
DATABASES = {
    ...
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///apeiro_agency",
    )
}
...
LOCAL_APPS = [
    "apeiro_agency.users.apps.UsersConfig",
...
MIGRATION_MODULES = {
    "sites": "apeiro_agency.contrib.sites.migrations"
}
...
MIDDLEWARE = [
    ...
    "orders.middlewares.basket_middleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "apeiro_agency.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "apeiro_agency.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "apeiro_agency.users.adapters.SocialAccountAdapter"
)
